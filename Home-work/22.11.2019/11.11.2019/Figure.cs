...
namespace _11._11._2019
{
    ...
    class Line : baseF
    {
        ...
        public Line(Point p1,Point p2, int thickness)
        {
            p1.Y -= thickness/2;
            p1.X -= thickness/2;
            this.rect.Location = p1;
            this.rect.Size = new Size(p2.X-p1.X, p2.Y - p1.Y);
            this.thickness = thickness;
            this.colorF = Color.Black;
            this.colorThickness = Color.Transparent;
        }
        public Line(Point p1, Point p2, int thickness, Color colorF, Color colorThickness)
        {
            this.rect = rect;
            this.colorF = colorF;
            this.colorThickness = colorThickness;
        ...
        public Line(Point p1, Point p2, int thickness, Color colorF)
        {
            this.rect = rect;
            this.colorF = colorF;
            this.colorThickness = Color.Transparent;
        ...
        public Line(Point p1, Point p2, Color colorThickness, int thickness)
        {
            this.rect = rect;
            this.colorF = Color.Transparent;
            this.colorThickness = colorThickness;
